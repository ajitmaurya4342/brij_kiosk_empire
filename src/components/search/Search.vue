<template>
    ...
    <div :class="'v-suggestions '+extendedOptions.inputMainClass">
    ...
    <div class="suggestions">
      <ul class="items searchItems" v-show="items.length > 0 && showItems === true">
        <li class="item"
            :key="index"
...
export default {
    ...
    const extendedOptions = Object.assign({}, defaultOptions, this.options)
      ...
      methods: {
        ...
        selectItem (index, item1) {
          window.location = '/movie-details-page?movieId=' + item1.ID
          let item = null
