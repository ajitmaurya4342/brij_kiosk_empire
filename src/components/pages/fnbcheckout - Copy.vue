<template>
  <div>
              ...
              >
                ...
                >
                  <td
                    class="seat-cat"
                    v-bind:class="
                      langName == 'ar' ? 'ar-seat-cat text-left' : 'text-right'
                    "
                  >
                    <p>
                      {{ seatType.SeatType }}
      ...
      <div class="col-12 col-md-11 px-0 mx-auto mt-5">
        <div class="my-4 text-center cus-list mb-5 fnb-sticky-header">
          ...
          <ul class="list-inline fbCat">
            ...
            <li
              v-for="(category, foodCategoryIndex) in foodAndBeverages.listing"
                    ...
                    <div>
                      <div>
                        ...
                        >
                          ...
                          <button
                            class="increase"
                            v-on:click="onSelectFoodItem(fbBox, 'add', fbIndex)"
                            id="increase"
                            type="button"
                            data-inc="1"
                          >
            ...
            <div class="d-flex h-100 premiere-fb-box red-fb-box">
              ...
              <div class="fbDetails">
                <div>
                  ...
                  <p class="fb-price">Qty: {{ fbBox.Qty }}</p>
                  <p class="fb-price">
                    {{ fbBox.Currency }} {{ changeNumberFormat(fbBox.Amount) }}
                  </p>
                </div>
                <div class="d-flex justify-content-end pr-0 pr-xl-3">
                  <!-- <div>
                  ...
                  <div>
                    <div>
                      <div
                        class="d-flex counter-box mr-0 mr-md-3"
                        v-bind:class="langName == 'ar' ? 'ar-counter-box' : ''"
                      >
                        <button
                          class="decrease"
                          v-on:click="onSelectFoodItem(fbBox, 'subtract', fb2)"
                          id="decrease"
                          type="button"
                          data-inc="-1"
                        >
      ...
      <div v-if="sectionName.foodAndBeverages" class="p-3 border-top">
        <div class="row" v-bind:class="langName == 'ar' ? 'mr-0' : 'ml-0'">
          ...
          <div class="col">
            ...
            <button
              v-if="fromQrCode == true && foodAndBeverages.selected.length == 0"
              disabled
              class="btn btn-danger px-4 btn-red mw-150 ml-auto"
            >
              {{ allLanguageData.Checkout }}
    ...
    <section v-if="sectionName.checkout" class="container-fluid mb-5 pb-5">
      <div class="col-12 col-md-11 mx-auto px-0 mt-5">
        ...
        >
          ...
          <div
            class="col-12"
            v-if="CheckLoyaltyApplicable.length > 0 && successLoyality == false"
          >
            <div
              class="row border m-1 p-2"
    ...
    >
      ...
      <input type="text" name="mobile" v-bind:value="userDetails.phoneNumber" />
