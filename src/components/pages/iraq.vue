<template>
  <section class="container-fluid px-0">
    <div class="new-header">
      <router-link to="">
        <img src="@/assets/img/svg/empire-logo.svg" class="new-logo-img" alt=""></router-link>
      <div class="float-right">
        <a :href="url" class="text-white" download> click here to download <img class="down-img ml-2"
            src="@/assets/img/download-flat.png"></a>
      </div>
    </div>
...
export default {
    ...
    methods: {
      getPdf () {
        var self = this
        self.url = '/static/pdf/erbil.pdf'
        self.pdfdata = pdfvuer.createLoadingTask('static/pdf/erbil.pdf')
