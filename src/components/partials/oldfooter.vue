    ...
    <div class="col-md-11 mx-auto p-3">
      ...
      <div>
        ...
        >
          ...
          <div class="d-none d-md-block list-inline-item small">
            <!-- <router-link to="/landingpage" style="color: #ffffff;">
              <strong>{{ allLanguageData.Country }} - {{ selectedCountry }}</strong>
              <span style="text-decoration:underline;">{{ allLanguageData.SelectCountry }}</span>
            </router-link>-->
            <!--<b-dropdown
              id="dropdown-left"
              variant="default"
            ...
            >
              <b-dropdown-item v-on:click="changeCountry('Lebanon',119)">LEBANON</b-dropdown-item>
              <b-dropdown-item v-on:click="changeCountry('Saudi Arabia',230)">SAUDI ARABIA</b-dropdown-item>
              <b-dropdown-item v-on:click="changeCountry('Iraq',102)">IRAQ</b-dropdown-item>
            </b-dropdown>-->
          </div>
        </div>
      </div>
